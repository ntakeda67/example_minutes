...
public class Member extends EntityBase implements java.io.Serializable {
	...
	private Set memberSessions = new HashSet(0);
	...
	public Member(BigDecimal rid, String surName, String firstName,
			...
			Set meetingMembers, Set memberSession) {
		this.surName = surName;
		this.firstName = firstName;
		this.mailAddress = mailAddress;
		this.loginId = loginId;
		...
		this.memberSessions = memberSession;
		setBaseColumnsValue(rid, available, createDate, createUser,
	...
	public Set getMemberSessions() {
		return this.memberSessions;
	}

	public void setMemberSessions(Set memberSessions) {
